...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
    <div class="flex flex-col sm:flex-row sm:items-center gap-3 justify-between mb-4">
        ...
        <?php if ($canCreate): ?>
            <a href="<?= url('penjualan', ['action' => 'create']) ?>" class="btn btn-primary"><?= icon('plus', 'w-4 h-4') ?> Penjualan Baru</a>
        <?php endif; ?>
    </div>
                    ...
                    <td>
                        <div class="flex items-center justify-center gap-1">
                            ...
                            <?php if (has_role('Administrator') || has_role('Bendahara')): ?>
                                <a href="<?= url('penjualan', ['action' => 'edit', 'id' => $t['id']]) ?>" class="btn btn-ghost p-1.5" title="Ubah"><?= icon('edit', 'w-4 h-4') ?></a>
                            <?php endif; ?>
