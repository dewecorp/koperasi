...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        <div class="flex items-center justify-between mb-5">
            <div>
                <h2 class="font-semibold text-slate-800 text-lg">Ubah Penjualan</h2>
        ...
        <form method="post" action="<?= url('penjualan', ['action' => 'update', 'id' => $tx['id']]) ?>" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <?= csrf_field() ?>
            <div>
            ...
            <div>
                ...
                <input type="text" class="input" value="<?= e($tx['pelanggan'] ?? 'Umum') ?>" disabled>
            </div>
